...
public class DirectDistanceDialingServiceTests
{
    ...
    public DirectDistanceDialingServiceTests()
    {
        ...
        _directDistanceDialingService = new DirectDistanceDialingService(_mockDddHttpRepository.Object);
    }
    ...
    public async Task GetAllAsync_ReturnsAllDirectDistanceDialing()
    {
        ...
        _mockDddHttpRepository.Setup(repo => repo.GetAllAsync()).ReturnsAsync(ddds);
